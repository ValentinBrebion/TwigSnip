...
function activate(context) {
    const previewManager = PreviewManager_1.PreviewManager.getInstance();
    // Enregistrer la commande de prévisualisation
    const previewCommand = vscode.commands.registerCommand('twigsnip.previewTwig', (uri) => {
    ...
    context.subscriptions.push(provider, previewCommand);
}
